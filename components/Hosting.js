...
const Hosting = ({ img, title, description, buttonText }) => {
  return (
    <section className="relative mb-2 cursor-pointer">
      ...
      <div className="absolute top-0 flex flex-col items-start h-full justify-center sm:px-10 md:px-10 lg:px-20 xl:px-20 w-[544px] z-10">
        <h2 className="text-3xl md:text-3xl lg:text-5xl font-bold text-white">
          {title}
        </h2>
        <p className="text-base text-white md:text-base lg:text-lg w-[300px] md:w-[300px] lg:w-[360px] pt-3 md:pt-3 lg:pt-4">
          {description}
        </p>
